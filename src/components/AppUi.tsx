...
export function Icon({
  ...
  const icons: Record<IconName, string> = {
    ...
    sun: "M12 3v2.5m0 13V21m9-9h-2.5M5.5 12H3m15.36 6.36-1.77-1.77M7.41 7.41 5.64 5.64m12.72 0-1.77 1.77M7.41 16.59l-1.77 1.77M12 8a4 4 0 100 8 4 4 0 000-8z",
    moon: "M20 14.5A7.5 7.5 0 119.5 4 6.2 6.2 0 0020 14.5z",
    plus: "M12 5v14M5 12h14",
    close: "M18 6L6 18M6 6l12 12",
    back: "M19 12H5m0 0l7 7m-7-7 7-7",
  };
